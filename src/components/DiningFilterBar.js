...
export function DiningFilterBar({ filters, onFilterChange, islands, cuisines, amenities }) {
  ...
  const handleCuisineChange = (cuisine) => {
    onFilterChange({ cuisine: cuisine === filters.cuisine ? 'all' : cuisine });
  };
  ...
  return (
    <div className="filter-bar dining-filter-bar">
        ...
        {isExpanded && (
          <div className="filters-expanded">
            ...
            <div className="filter-group">
              ...
              <div className="filter-chips">
                <button
                  className={`filter-chip ${filters.cuisine === 'all' ? 'active' : ''}`}
